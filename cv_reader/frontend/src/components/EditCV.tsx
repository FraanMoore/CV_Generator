  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        setRawCv(raw);
        const mapped = mapCvMasterToEditData(raw, lang);
        reset(mapped);
      } catch (e) {
    ...
    <React.Fragment>
      <Container>
        <Stack direction="row" spacing={2} alignItems="center" marginTop={4}>
          <Button endIcon={<ArrowBackIosNewIcon />} onClick={handleBack} />
          <Typography>{t("Edit your CV details")}</Typography>
        </Stack>
        <DialogContent>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Autocomplete
                    ...
                    renderInput={(params) => (
                      <TextField {...params} label={t("Skills")} />
                    )}
                  />
                )}
              />
              <Controller
                ...
                render={({ field }) => (
                  <Autocomplete
                    ...
                    onChange={(_, newValue) => field.onChange(newValue)}
                    renderInput={(params) => (
                      <TextField {...params} label={t("UI Skills")} />
                    )}
                  />
                )}
              />
              <Controller
                ...
                render={({ field }) => (
                  <Autocomplete
                    ...
                    onChange={(_, newValue) => field.onChange(newValue)}
                    renderInput={(params) => (
                      <TextField {...params} label={t("APIs Skills")} />
                    )}
                  />
                )}
              />
              <Controller
                ...
                render={({ field }) => (
                  <Autocomplete
                    ...
                    onChange={(_, newValue) => field.onChange(newValue)}
                    renderInput={(params) => (
                      <TextField {...params} label={t("Tooling Skills")} />
                    )}
                  />
                )}
              />
